...
public class TreeLayoutFragment extends DialogFragment {
	...
	public TreeLayoutFragment(String title) {
		this.title = title;
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View v = inflater.inflate(R.layout.treevg, container, false);
		mPager = (TreeLayout) v.findViewById(R.id.treelayout);
		return v;
	}
	...
	public void onActivityCreated(Bundle arg0) {
		...
		TreeLayoutChildAdapter tca = new TreeLayoutChildAdapter(this, getActivity(), getCurTreeList(""));
		listview.setAdapter(tca);
		listview.setCacheColorHint(0x00000000);
		
		mPager.addView(listview);
